...
if __name__ == '__main__':
	...
	lr_feature = 0.0003
	lr_gm = 0.01
	path_log = 'logs/sms_random.txt'

	jl = JL(n_classes, file_L, file_U, file_V, file_T, False)
	fm, gm = jl.fit(mask, batch_size, lr_feature, lr_gm, path_log, True, 100, -1, 7, True, True, 0.9, 0.85, 512, 'nn', 'binary')
	# print(fm.shape)
	# print(gm.shape)